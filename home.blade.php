            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <img src="img/logo.png" style="width: 150px; height: 100px;">
                        ...
                        <a href="#menu-toggle" class="btn btn-success" id="menu-toggle" style="position: absolute; left: 10px; top: 150px; font-size: 30px;">Get In</a>
                        <div class="pov" style="position: absolute; left: 400px; top: 200px; font-size: 3em; color: white;"><q>LVCC sfmbjsab fasif dsiha</q></div>
                    </div>
                </div>
            </div>
